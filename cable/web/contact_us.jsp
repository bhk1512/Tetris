...
<div id="wrapper">
  <div class="menuZone">
    <ul>
      ...
      <li><a class="current" href="contact_us.jsp">Contact Us</a></li>
  ...
  <div class="banner">
    <div class="bannerText1">
      <h1>WHY D-TV ?</h1>
      <ul>
        <li>Over <span class="yelloText">125+</span> Channels</li>
        <li>Starting Package from<span class="yelloText"> Rs.230 only</span></li>
    ...
    <div class="button"> <a><img src="images/button.png" alt="" border="0" /></a></div>
      ...
      <div class="subscribetop">
        <div class="subscribebottom">
          <div style="padding:20px 15px 20px 15px;">
            ...
            <div> <strong> <br />
              We’re happy to answer any questions you have or provide you with an estimate. Just send us a message in the form below. </strong><br />
            </div>  
            <div> <br />
            ...
            <div> <br />
              ...
              <p> <span><img src="images/ico-phone.png" alt="" width="20" height="16" hspace="2" /> Phone:</span> (888) 123 456 789<br />
                ...
                <span><img src="images/ico-website.png" alt="" width="20" height="16" hspace="2" /> Website:</span> <a>www.mycompany.com</a><br />
                <span><img src="images/ico-email.png" alt="" width="20" height="16" hspace="2" /> Email:</span> <a>info@mycompany.com</a><br />
                <span><img src="images/ico-twitter.png" alt="" width="20" height="16" hspace="3" /> <a>Follow</a> on Twitter</span><br />
              </p>
            </div>
          </div>
          <div class="clear"></div>
  ...
  <div class="bottomcontainer">
    <div class="bottomMenu">
      <ul>
        Copyright (c) Sitename.com. All rights reserved. Design by Stylish Website Templates.
      </ul>
      <div class="clear"></div>
    </div>
  </div>
