<%-- 
    Document   : privacy
    Created on : Jul 13, 2014, 10:18:30 AM
    Author     : Home
--%>
...
<div id="wrapper">
  <div class="menuZone">
    <ul>
      ...
      <li><a class="current" href="privacy.jsp">Privacy</a></li>
  ...
  <div class="banner">
    ...
    <div class="button"> <a href="http://www.free-css.com/"><img src="images/button.png" alt="" border="0" /></a></div>
        ...
        <div class="subscribebottom">
          <div style="padding:20px 15px 20px 15px;">
            ...
            <div> <strong> <br />
              ...
              By using our site, you consent to our <a href="http://www.free-css.com/">websites privacy policy</a>.<br />
              <br />
